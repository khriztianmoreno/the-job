      ...
      <div className="row">
        <div className="col-sm-12 col-md-6">
          ...
          <p className="text-justify">
            An employment website is a web site that deals specifically with employment or careers.
            ...
            employer reviews, career and job-search advice, and describe different job descriptions
            or employers. Through a job website a prospective employee can locate and fill out a
            job application.
          </p>
        </div>
      ...
      <div className="row">
        <div className="col-md-8 col-sm-6 col-xs-12">
          <p className="copyright-text">
            Copyrights &copy; 2018 All Rights Reserved by <a href="http://khriztianmoreno.com">Khriztianmoreno</a>.
          </p>
        </div>
        ...
        <div className="col-md-4 col-sm-6 col-xs-12">
          <ul className="social-icons">
            ...
            <li>
              <a className="instagram" href="https://instagram.com/khriztianmoreno">
